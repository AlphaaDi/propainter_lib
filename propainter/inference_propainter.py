...
def read_masks_from_path(mpath):
    masks_img = []
...
def process_mask(masks_img, length, size, flow_mask_dilates=8, mask_dilates=5):
    masks_dilated = []
    flow_masks = []
...
def read_mask(mpath, length, size, flow_mask_dilates=8, mask_dilates=5):
    masks_img = read_masks_from_path(mpath)
    return process_mask(masks_img, length, size, flow_mask_dilates, mask_dilates)
