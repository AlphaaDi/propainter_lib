...
from propainter.inference_propainter import *


def inference_propainter_inline(video_path, masks, device, model_dir='weights'):
    args = Munch({
        "video": "inputs/object_removal/people/frames",
        "mask": "inputs/object_removal/people/masks",
        "output": "results", "resize_ratio": 1.0,
        "height": 720, "width": 720, "mask_dilation": 1,
        "ref_stride": 10, "neighbor_length": 10, "subvideo_length": 50,
        "raft_iter": 20, "mode": "video_inpainting", "scale_h": 1.0,
        "scale_w": 1.2, "save_fps": 24,
        "save_frames": False, "fp16": True,
    })
    ...
    flow_masks, masks_dilated = process_mask(masks, frames_len, size, 
    ...
    comp_frames = [cv2.resize(f, size) for f in comp_frames]
